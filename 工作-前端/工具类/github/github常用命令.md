...
- 版本库👉`.git`
  ...
  - `.git文件`另外一个作用就是它在创建的时候，会自动创建 master 分支，并且将HEAD指针指向 master 分支。
- 工作区
  - 本地项目存放文件的位置
  - 可以理解成图上的 workspace
- 暂存区 (Index/Stage)
...
![Git配置命令](${img}/29f0c70414b14fe1986b376f7b303959_tplv-k3u1fbpfcp-zoom-1.image)
...
![Git分支管理](${img}/3bff7ddbc6a145f993c0841eb81c8998_tplv-k3u1fbpfcp-zoom-1.image)
...
// 举个例子👇
git checkout -b feature/tiantia
```
...
![Git命令fetch](${img}/6c666ec139fe4dc5a08df6b811b9803d_tplv-k3u1fbpfcp-zoom-1.image)
...
![Git花式撤销](${img}/f29320c710544828a494918b1ec2da05_tplv-k3u1fbpfcp-zoom-1.image)
...
![Git文件比较](${img}/c779e736198247bfb0795b50dced0814_tplv-k3u1fbpfcp-zoom-1.image)
